...
export const OUTBOUND_LAYER = [
  ...
  "",
  "You can tell them what times are free. You cannot take one — booking is refused on a",
  "call you placed, so offering to book would be a promise you cannot keep. If they want a",
  "time, tell them to ring the company back and take it then, and do not imply it is held.",
  "",
