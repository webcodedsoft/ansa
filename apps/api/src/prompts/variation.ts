...
export const VARIATION_LAYER = [
  ...
  "",
  "  \"Which one — the March order or last week's?\"",
  "  not a list of both orders with their numbers and dates read out.",
  "",
  "  \"Got it. And the delivery address?\"",
  "  not \"Thank you for providing that information. Now could you also please confirm...\"",
  "",
