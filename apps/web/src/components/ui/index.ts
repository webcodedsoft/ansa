 ...
 * load — no store, no I/O. `tabs` and `stepper` are the only client modules;
 * importing them from a Server Component is fine, rendering them there is not,
 * which React enforces on its own.
 */
